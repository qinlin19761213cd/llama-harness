...
public class PerfAnalyzerV2Tests
{
    ...
    public void ParseSessions_SplitsByBoundary_AndAggregatesAllKinds()
    {
        var path = WriteTempLog(new[]
        {
            ...
            "count,2026-09-01 10:00:07.000,evict=2,preempt=1,log_dropped=7,log_flush=2.50,kv_hit=95,kv_false=5,saved_n=4096,kv_full=8,kv_reuse_tok=13971,kv_reuse_ms=14531.2", // v2.23.11
        ...
        Assert.Equal(13971, s1.KvReuseTokens); // v2.23.11 ROI
        Assert.Equal(14531.2, s1.KvReuseSavedMs); // v2.23.11 ROI
